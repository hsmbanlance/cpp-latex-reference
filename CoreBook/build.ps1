...
<#
.SYNOPSIS
    编译C++ 核心指南详解 (XeLaTeX 双pass)
.DESCRIPTION
    使用 MiKTeX XeLaTeX 编译 cpp_core_guidelines_textbook.tex，生成 PDF。
...
$texFile   = 'cpp_core_guidelines_textbook.tex'
$jobName   = 'cpp_core_guidelines_textbook'
