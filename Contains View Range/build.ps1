...
<#
.SYNOPSIS
    编译C++ 容器、视图与范围完全参考 (XeLaTeX 双pass)
.DESCRIPTION
    使用 MiKTeX XeLaTeX 编译 containers_views_ranges.tex，生成 PDF。
...
$texFile   = 'containers_views_ranges.tex'
$jobName   = 'containers_views_ranges'
